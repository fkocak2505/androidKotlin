...
import kotlinx.android.synthetic.main.custom_dialog_elegant_cons.*

class PopupClass(private val mContext: Context?) {
    ...
    init {
        ...
        mDialog.setContentView(R.layout.custom_dialog_elegant_cons)
    }
