...
public class VideoPlayerRecyclerView extends RecyclerView {
    ...
    public void playVideo(boolean isEndOfList) {
        ...
        if(targetPosition == mediaObjects.size() - 1)
            currentPosition = targetPosition - ((LinearLayoutManager) getLayoutManager()).findFirstVisibleItemPosition() + 1;
        else
        ...
        if (targetPosition == mediaObjects.size() - 1)
            ...
            mediaUrl = mediaObjects.get(targetPosition - 1).getMedia_url();
        if (mediaUrl != null) {
