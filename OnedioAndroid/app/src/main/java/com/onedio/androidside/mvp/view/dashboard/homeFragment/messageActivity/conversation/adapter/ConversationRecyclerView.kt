package com.onedio.androidside.mvp.view.dashboard.homeFragment.messageActivity.conversation.adapter
...
import com.onedio.androidside.mvp.view.dashboard.homeFragment.messageActivity.conversation.holder.HolderDate
import com.onedio.androidside.mvp.view.dashboard.homeFragment.messageActivity.conversation.holder.HolderMe
import com.onedio.androidside.mvp.view.dashboard.homeFragment.messageActivity.conversation.holder.HolderYou
...
class ConversationRecyclerView(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        when (viewType) {
            DATE -> {
                val vDate = inflater.inflate(R.layout.message_holder_date, parent, false)
                viewHolder =
                    HolderDate(
                        vDate
                    )
            ...
            YOU -> {
                val vYou = inflater.inflate(R.layout.message_holder_you, parent, false)
                viewHolder =
                    HolderYou(
                        vYou
                    )
            ...
            ME -> {
                val vMe = inflater.inflate(R.layout.message_holder_me, parent, false)
                viewHolder =
                    HolderMe(
                        vMe
                    )
    ...
    private fun configureViewHolderDate(vh1: HolderDate, position: Int) {
        ...
        vh1.getDate()?.typeface = OnedioCommon.changeTypeFace4Activity(context)
    }
