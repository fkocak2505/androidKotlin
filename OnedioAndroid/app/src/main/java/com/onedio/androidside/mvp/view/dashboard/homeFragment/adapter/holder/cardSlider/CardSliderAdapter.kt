package com.onedio.androidside.mvp.view.dashboard.homeFragment.adapter.holder.cardSlider
...
class CardSliderAdapter(
...
): RecyclerView.Adapter<CardSliderAdapter.HugeCardModelViewHolder>() {
    ...
    class HugeCardModelViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val lastViewLine4SliderListItem: View = view.findViewById(R.id.lastViewLine4SliderListItem)
        ...
        fun bindItems(
            ...
            flagImage.init(context as FragmentActivity)

            setArticleItemData(context, item)

            //setArticleItemTypeface(activity)

            setArticleItemOnClick(item, listener, pos, context)

            setArticleItemViewsColor(context)
        ...
        private fun setArticleItemOnClick(
            ...
            commentConstraintLayout.setOnClickListener {
                listener(item, pos, OnedioConstant.COMMENTS, flagImage, commentConstraintLayout, false)
            }
            ...
            articleAction.setOnClickListener {
                listener(item, pos, OnedioConstant.CATEGORY_ICON, articleAction, articleAction, false)
            }
        ...
        private fun loadImage(
            ...
            //imageView.loadImage(context, imageUrl, R.drawable.image_error_dark_mode)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HugeCardModelViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.widget_huge_card_slider_list_item, parent, false)
        return HugeCardModelViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: HugeCardModelViewHolder, position: Int) {
        holder.bindItems(context, hugeCardList[position], position, listener)
    }
