...
import kotlinx.android.synthetic.main.elegant_dialog_cons.*

class PopupClass(private val mContext: Context?, private val isForce: Boolean) {
    ...
    private var elegantActionListener: CustomElegantActionListeners? = null
    ...
    init {
        ...
        mDialog.setContentView(R.layout.elegant_dialog_cons)
    }

    /** Set Your custom View.
     * Can be any type of view we will compensate the min height*/
    fun setCustomView(layout: Int): PopupClass {
    ...
    private fun initiateAllViews() {
        ...
        closeIconView = mDialog.closeButton

        if(isForce){
            closeIconView!!.visibility = View.GONE
        }else{
            closeIconView!!.visibility = View.VISIBLE
            closeIconView!!.setImageResource(R.drawable.ic_cross)
        }
        ...
        closeButton = mDialog.closeButton
            ...
            if (this.titleIcon != null) {
                val layerDrawable =
                    ContextCompat.getDrawable(
                        mContext,
                        R.drawable.custom_elegant_round_icon
                    ) as LayerDrawable
    ...
    fun setTitleIcon(titleIcon: Drawable): PopupClass {
    ...
    fun setTitleIconColor(titleIconColor: Int): PopupClass {
     ...
     * Will only applied if you pass an icon @setTitleIcon()  */
    fun setTitleIconBackgroundColor(titleIconBackgroundColor: Int): PopupClass {
    ...
    fun setBackgroundTopColor(backgroundTopColor: Int): PopupClass {
     ...
     * The Dialog is split into two and Color has to be an Int */
    fun setBackgroundBottomColor(backgroundBottomColor: Int): PopupClass {
     ...
     * You can do anything you want like you normally do with other TextViews*/
    fun getPositiveButtonTextView(): Button? {
    ...
    fun setElegantActionClickListener(elegantActionListener: CustomElegantActionListeners): PopupClass {
    ...
    fun setCanceledOnTouchOutside(cancelledOnTouchOutside: Boolean): PopupClass {
    ...
    fun setTitleHidden(hideTitle: Boolean): PopupClass {
    ...
    fun setCornerRadius(cornerRadius: Float): PopupClass {
    ...
    private fun onCloseClicked(dialog: View) {
        if (elegantActionListener != null) {
            elegantActionListener!!.onCloseClicked(this)
        }
    }
