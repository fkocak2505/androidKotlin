...
class CategoryFeedActivityModelImpl :
    ICategoryFeedActivityModel {
    ...
    override fun initApiSeriviceFeedUrl() {
        iApiService = ApiUtils.getAPIServiceSlider()
    }

    override fun getArticleFeedByCategoryId(
        categoryId: String,
        page: Int,
        perPage: Int,
        ...
        iApiService.getCategoryWidgetDataWithTargetId(categoryId, page, perPage, dateFilterType, sortType)
    ...
    override fun getArticleFeedByCategoryIdNew(
        ...
        initApiSeriviceFeedUrl()

        iApiService.getArticleFeedCategoryWidgetDataWithCategoryId(categoryId, page,  perPage,dateFilterType, sortType)
