...
import com.onedio.androidside.mvp.view.dashboard.homeFragment.articleDetail.holder.*

class EntriesRecyclerViewAdapter(
    val context: Context,
    val items: MutableList<EntriesModelData>,
    val listener: (EntriesModelData) -> Unit
    ...
    private fun configureViewHolderEntriesOnedioEmbed(vh1: HolderEntriesOnedioEmbed, position: Int) {
