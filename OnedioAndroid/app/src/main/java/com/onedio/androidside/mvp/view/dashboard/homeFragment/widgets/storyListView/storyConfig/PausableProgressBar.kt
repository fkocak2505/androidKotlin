package com.onedio.androidside.mvp.view.dashboard.homeFragment.widgets.storyListView.storyConfig
...
internal class PausableProgressBar @JvmOverloads constructor(@NonNull context: Context, @Nullable attrs: AttributeSet? = null, @AttrRes defStyleAttr: Int = 0) :
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.story_pausable_progress, this)
