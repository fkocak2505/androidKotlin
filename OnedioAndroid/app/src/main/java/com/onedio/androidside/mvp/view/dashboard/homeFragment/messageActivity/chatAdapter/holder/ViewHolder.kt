package com.onedio.androidside.mvp.view.dashboard.homeFragment.messageActivity.chatAdapter.holder
...
class ViewHolder (itemLayoutView: View, private val listener: ClickListener?) :
    ...
    init {
        ...
        photoProgress = itemLayoutView.findViewById(R.id.photoProgress) as ProgressBar
