...
public class NavMenuListViewDataModel {
    ...
    public NavMenuListViewDataModel(int itemIcon, String itemName, String itemBadge, int itemDetailIcon, boolean isShowBadge, boolean isShowDetailIcon) {
